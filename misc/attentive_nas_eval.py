        ...
        for net_id in subnets_to_be_evaluated:
            if net_id == "attentive_nas_min_net":
                ...
                supernet.set_active_subnet(
                    ...
                    subnets_to_be_evaluated[net_id]["bit_width"],
                )
            ...
            (
                ...
                train_loader, subnet, criterion, args, logger, device, writer
            )
            print("train acc Top1: {}, Top5:{}".format(acc1_train, acc5_train))
            acc1, acc5, loss, flops, params = validate_one_subnet(
                val_loader, subnet, criterion, args, logger, device, writer
            )
